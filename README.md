# TODO
- Убрать редактор структуры
- Создать формат представления структуры



- Структура
    - Ошибка при удалении всех блоков (при удалении текущего нода, ссылка на него висит в currentNode)
