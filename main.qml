...
ApplicationWindow {
    ...
    Item {
        ...
        Row {
            ...
            Item {
                width: hexLetter.width * 11
                height: bgrItem.height
            }

            Item {
                width: 4 + 2 + 4 + hexLetter.width / 2
                height: 1
            }

            Rectangle {
                id: colHex1
                width: hexLetter.width * (2 * 4 + 3 + 1)
                height: bgrItem.height
